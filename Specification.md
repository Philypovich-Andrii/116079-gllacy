...
- Сетка: четыре колонки равной ширины (22.2% - 267px).
...
– Внутренние отступы слева и справа для обоих страницы — по 2.3% (27px) от ширины всей контентной области.
- Отступы между колонками сетки одинаковые — по 2.2% (26px) от ширины всей контентной области.
